...
public class RecordedFragment extends Fragment {
    ...
    private final String ACTIVITY_TITLE = "Recorded";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.recorded_recyclerview);
